...
struct mint {
	...
	inline mint operator+(const mint &t) const { return add(v, t.v); }
	inline mint operator-(const mint &t) const { return sub(v, t.v); }
	...
	inline void operator+=(const mint &t) { Add(v, t.v); }
	inline void operator-=(const mint &t) { Sub(v, t.v); }
